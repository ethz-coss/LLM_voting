...
def run_game():
    ...
    init_message = Message(time=0, content="You are playing a game repeatedly with another player. In this game, you can choose between Option J and Option F. You will play 10 rounds in total with the same player. The rules of the game are as follows: If you choose Option J and the other player chooses Option J, then you win many points and the other player wins medium points. If you choose Option J and the other player chooses Option F, then you win no points and the other player wins no points. If you choose Option F and the other player chooses Option J, then you win no points and the other player wins no points. If you choose Option F and the other player chooses Option F, then you win medium points and the other player wins no points. Say only the letter corresponding to your action and no other tokens. You must always give an answer. You want to get as much points as possible.", role="system")
    ...
    # scores = {"JJ":["many", "medium"], "JF":["no", "no"], "FJ":["no", "many"], "FF":["medium", "many"]}
    ...
    for i in range(1, 10):
        m1 = Message(time=i, content="In round " + str(i) + " you chose Option " + r1.content + " and the other player chose Option " + r2.content + ". Thus, you won " + str(score1) + " points and the other player won " + str(score2) + " points You are currently playing round " + str(i+1) + ". Q: Which Option do you choose, Option J or Option F?", role="user")
